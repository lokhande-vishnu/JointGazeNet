#ifndef CAFFE_EUCLIDEAN_GAZE_LOSS_LAYER_HPP_
#define CAFFE_EUCLIDEAN_GAZE_LOSS_LAYER_HPP_
...
class EuclideanGazeLossLayer : public LossLayer<Dtype> {
 public:
  explicit EuclideanGazeLossLayer(const LayerParameter& param)
      : LossLayer<Dtype>(param), diff_() {}
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);

  virtual inline const char* type() const { return "EuclideanGazeLoss"; }
  /**
...
#endif  // CAFFE_EUCLIDEAN_GAZE_LOSS_LAYER_HPP_
